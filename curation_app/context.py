...
from curation_app.config import DEFAULT_MANIFEST, DOWNLOADS_DIR, IMPORTS_DIR, REGISTRY_DIR
...
def source_context(source_id: str, manifest_df: pd.DataFrame) -> SourceContext:
    ...
    return SourceContext(
        ...
        candidates_tsv=REGISTRY_DIR / f"pair_alignment_candidates_{slug}.tsv",
